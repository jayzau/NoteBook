...
![部分切好的验证码字符，还没有输入正确的名字](/images/notes/Tensorflow_CNN_验证码识别/pic_cut.png)

- 训练好的模型长这样

![训练好的模型长这样](/images/notes/Tensorflow_CNN_验证码识别/model.png)
...
![y轴是成功率，x轴代表训练了多少轮](/images/notes/Tensorflow_CNN_验证码识别/trend_chart.png)
...
![识别这种验证码也是难为机器了](/images/notes/Tensorflow_CNN_验证码识别/failed.png)
